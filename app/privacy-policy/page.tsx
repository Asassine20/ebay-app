export const metadata = {
    title: 'Privacy Policy - Restock Radar',
    description: 'Learn about our privacy practices, data collection, and your rights at Restock Radar.',
  };
  ...
  export default function PrivacyPolicy() {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-gray-600 mb-6">Last updated: December 21, 2024</p>
        <p className="mb-4">
        ...
        <ul className="list-disc ml-8 mb-4">
          ...
          <li className="mb-2">
            <strong>Website:</strong> refers to Restock Radar, accessible from{' '}
            <a
              href="https://restockradar.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-500 underline"
            >
              https://restockradar.com
            </a>
            .
          </li>
          <li className="mb-2">
        ...
        <p className="mb-4">
          ...
          Internet Protocol address (e.g., IP address), browser type, browser version, the pages of our Service that You
          visit, the time and date of Your visit, the time spent on those pages, unique device identifiers, and other
          diagnostic data.
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc ml-8">
          <li>
            By email: <a href="mailto:asassine44@gmail.com" className="text-blue-500 underline">asassine44@gmail.com</a>
          </li>
        </ul>
      </div>
    );
